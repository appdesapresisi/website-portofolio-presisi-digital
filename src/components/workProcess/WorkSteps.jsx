...
const WorkSteps = ({ data, style }) => {
  ...
  return (
    <div
      className={`rounded-xl bg-white hover:drop-shadow-2xl shadow-gray-300 ease-out duration-1000 ${
        style && style
      }`}
    ...
    >
      <div
        className={`w-11 h-11 sm:w-18 sm:h-18 ${
          hover ? "bg-picto-primary" : "bg-white border border-gray-300"
      ...
      >
        ...
        >
          <path d={data?.svgPath} fill={`${hover ? "#FFFFFF" : "#0369A1"}`} />
        </svg>
      </div>
